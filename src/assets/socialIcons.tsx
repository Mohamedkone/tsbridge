...
// Facebook Icon with real colors
const FacebookIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path 
...
// Microsoft Icon (your existing one)
const MicrosoftIcon = () => (
...
export { GoogleIcon, FacebookIcon, GitHubIcon, MicrosoftIcon };